...
url1 = "https://books.toscrape.com/catalogue/page-2.html"

# Realizar una solicitud GET a la página web
print("Frist response: "+ url1)
...
if response.status_code == 200:
    ...
    with open("librostest2.csv", "w", newline="", encoding="utf-8") as csvfile:
        fieldnames = ["Título", "Precio", "Rating", "Descripcion","Disponibilidad"]
        #fieldnames = ["Título", "Precio", "Rating", "Descripcion"]
